...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>ANALISIS</strong> NÚMERICO", None))
        self.label_description.setText(QCoreApplication.translate("SplashScreen", u"<strong>TAREA</strong> FINAL", None))
        self.label_loading.setText(QCoreApplication.translate("SplashScreen", u"CARGANDO...", None))
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Created</strong>: DIEGO", None))
    # retranslateUi
