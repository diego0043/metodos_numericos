...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.labelTitle.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p><span style=\" font-weight:600; color:#9b9bff;\">ANÁLISIS</span> NUMÉRICO</p></body></html>", None))
        ...
        self.labelLoadingInfo.setText(QCoreApplication.translate("SplashScreen", u"Cargando...", None))
    # retranslateUi
